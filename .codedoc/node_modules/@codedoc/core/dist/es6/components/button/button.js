...
export const ButtonStyle = /*#__PURE__*/ themedStyle(theme => ({
    button: {
...
export function Button(options, renderer) {
    const classes = this.theme.classes(ButtonStyle);
    let _class = classes.button;
    if (options.icon === 'true')
        _class += ' icon icon-font';
    if (options.url)
        return renderer.create("a", { class: _class, href: options.url, target: "_blank" }, options.label || '');
    else
