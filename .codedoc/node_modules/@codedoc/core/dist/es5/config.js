...
var formula_1 = require("./components/formula");
...
var zoom_on_formula_1 = require("./components/formula/zoom-on-formula");
exports.DefaultMarkdownCustomComponents = {
    Tab: tabs_1.Tab, Tabs: tabs_1.Tabs, Collapse: collapse_1.Collapse, Formula: formula_1.Formula,
...
exports.DefaultMarkdownCustomInlineComponents = {
    Formula: formula_1.InlineFormula,
    Icon: icon_1.Icon,
};
exports.DefaultToCMarkdownCustomComponents = {
    Button: button_1.Button, Buttons: button_1.Buttons, Collapse: collapse_1.Collapse, Formula: formula_1.Formula,
    DarkLight: darklight_1.DarkLight, InDark: darklight_1.InDark, InLight: darklight_1.InLight,
    GithubButton: github_1.GithubButton, Watermark: watermark_1.Watermark,
};
...
exports.DefaultConfig = {
    ...
    bundle: {
        init: [
            ...
            post_nav_1.postNavSearch$, zoom_on_formula_1.zoomOnFormula$,
        ],
    },
    dev: {
        port: 3000
...
function configuration(override) {
    ...
    if (override.markdown) {
        ...
        if (override.markdown.customInlineComponents)
            res.markdown.Link = marked_1.linkedComponents(override.markdown.customInlineComponents);
    }
    if (override.tocMarkdown) {
        ...
        if (override.tocMarkdown.customInlineComponents)
            res.tocMarkdown.Link = marked_1.linkedComponents(override.tocMarkdown.customInlineComponents);
    }
    if (override.misc)
